...
// --- 示教系统全局标志位 ---
int current_state = 0;    // 0: IDLE, 1: TEACHING, 2: READY [cite: 339, 340]
bool has_start = false;   // 是否记录了起点 [cite: 341]
bool has_end = false;     // 是否记录了终点 [cite: 341]
bool has_w1 = false;      // 是否记录了第一个过渡点 (对应指令 W)
bool has_w2 = false;      // 是否记录了第二个过渡点 (对应指令 X)
int waypoint_count = 0;
//0326
int final_start_pos[5]; // 确保数组也在这里定义
int final_end_pos[5];
